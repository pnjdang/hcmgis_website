                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        >
                            <ul id="nav" class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a class="page-scroll active" href="#tongquan">Tổng quan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="#chucnang">Chức năng</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="#nhiemvu">Nhiệm vụ</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="#linhvuc">Linh vực hoạt động</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="#nhansu">Nhân sự</a>
                                </li>
                            </ul>
                        </div>
                        <!-- navbar collapse -->
